...
public class GUI
{
	...
	public World getWorld(){ return world; }
        ...
        public void loadFont(String name, String key, int style, float size)
        {
            try {
                File file =  new File("resources/fonts/"+name+".ttf");                
	...
	{
            loadFont("Terminus", "dialogueFont", Font.BOLD, 30.0f);
            ...
            loadAnimation("idle","bigturret.idle", "objects.bigturret.bigTurretIdle");
            loadAnimation("fire","bigturret.fire", "objects.bigturret.bigTurretFire",6,30,false);
            loadAnimation("idle","stupiddroid.idle", "objects.basicdroid.basicdroid");
            loadAnimation("idle","factory.idle","objects.factory.factory",2,1000,true);
            loadAnimation("idle","floors.teleport","objects.floors.teleport.teleportIdle",2,1000,true);
